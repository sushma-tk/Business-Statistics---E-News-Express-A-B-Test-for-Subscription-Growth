...
E-news Express was experiencing a decline in new monthly subscriptions. The executive team hypothesized that the existing landing page lacked sufficient design and content to keep visitors engaged long enough to subscribe.This project utilized A/B testing to compare the performance of the existing page (Control Group) against a newly designed page (Treatment Group).
